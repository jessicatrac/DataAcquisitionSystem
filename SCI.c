...
void SCI_Init(unsigned short baudRate){     // CHANGED for bus speed of 4MHz, not 6.25MHz
  SCI0BDH = 0;   // br=MCLK/(16*baudRate) 
  
  switch(baudRate){
    case 2400:  SCI0BDL=156; break;
    case 4800:  SCI0BDL=78;  break;
    case 9600:  SCI0BDL=26;  break;
    case 19200: SCI0BDL=13;  break; // actual 19230 bps 
    case 38400: SCI0BDL=7;  break;
    default:    SCI0BDL = 13 ;  // 19200  
  }
  SCI0CR1 = 0;
/* bit value meaning
...
void SCI_OutUDec(unsigned short n, unsigned short counter){          
// This function uses recursion to convert decimal number
//   of unspecified length as an ASCII string 
  int temp = n; 
  if(n >= 10){
      SCI_OutUDec(n/10,counter+1);
      n = n%10;
    }
  
  while(counter<2 && temp<10) {
    SCI_OutChar(0 + '0');
    counter = counter + 1;}
  SCI_OutChar(n+'0');  
